...
static const char *usage[]={
    ...
    "  -opt -REC_OPT  set the receiver dependent option"
};
...
#define ISTOPT  "0:off,1:serial,2:file,3:tcpsvr,4:tcpcli,7:ntripcli,8:ftp,9:http,12:udpsvr,13:udpcli"
...
static void prstream(vt_t *vt)
{
    ...
    const char *type[]={
        ...
        "http","ntripc_s","ntripc_c","udpsvr","udpcli"
    };
